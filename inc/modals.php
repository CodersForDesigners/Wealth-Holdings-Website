				...
				<div class="row">
					<div class="modal-share columns small-12 medium-8 medium-offset-2 large-6 large-offset-3 fill-light space-50">
						...
						<div class="url-share space-25-bottom">
							<input type="text" class="url block fill-blue-4">
							<button class="button">Copy</button>
							<label class="feedback small text-neutral-2">Copied to Clipboard</label>
						</div>
						<div class="social-share">
							<a href="" class="share-button inline" style="background-image: url('../media/icon/icon-social-facebook.svg<?php echo $ver ?>'); background-color: #1877f2;">Facebook</a>
							<a href="" class="share-button inline" style="background-image: url('../media/icon/icon-social-linkedin.svg<?php echo $ver ?>'); background-color: #007BB5;">LinkedIn</a>
							<a href="" class="share-button inline" style="background-image: url('../media/icon/icon-social-twitter.svg<?php echo $ver ?>'); background-color: #69ACE0;">Twitter</a>
							<a href="" class="share-button inline" style="background-image: url('../media/icon/icon-social-whatsapp.svg<?php echo $ver ?>'); background-color: #3AC34C;">WhatsApp</a>
							<a href="" class="share-button fill-red-2 inline" style="background-image: url('../media/icon/icon-share-more.svg<?php echo $ver ?>');">More</a>
						</div>
					</div>
				</div>
			</div>
